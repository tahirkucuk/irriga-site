...
$log[]=['BAGLANTI',$r()];
$c('EHLO irrigatr.com','EHLO');
if($port===587){$c('STARTTLS','STARTTLS');@stream_socket_enable_crypto($fp,true,STREAM_CRYPTO_METHOD_TLS_CLIENT);$c('EHLO irrigatr.com','EHLO2');}
$c('AUTH LOGIN','AUTH');
